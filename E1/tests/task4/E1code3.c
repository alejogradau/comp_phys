...
int main(int argc, char **argv)
{
   ...
   */
    bool code1 = true;
    bool code4 = false; // Check code4's output file's name
    ...
    if(code4)
    {
      read_data("csv/abs_total_displacements.csv", time_array, signal);
    }

    if(kinetic_spectrum)
    {
      read_data("csv/kinetic.csv", time_array, signal);
    }
     ...
     */
     ...
     if(code4)
     {
       write_to_file("csv/powerspectrum_code4.csv",
       frequencies, fftd_data, N_POINTS);
     }
