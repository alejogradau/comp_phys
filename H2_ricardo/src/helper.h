...
extern double calc_autocorrelation(double alpha, int run, unsigned long length, double time_series[length], double autocorrelation[length/2]);

extern double calc_block_average(double alpha, int run, unsigned long length, double time_series[length], double block_average[length/2]);
...
extern void file_to_array(double alpha, int run, unsigned int length, double data[length]);
