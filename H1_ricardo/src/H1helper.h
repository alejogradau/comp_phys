...
extern void write_observable_file(char *fname, char* oname, double *time_array, int n_timesteps, double O[n_timesteps]);

extern void calc_time_average(int n_timesteps, double O[n_timesteps], double O_exp[n_timesteps]);
