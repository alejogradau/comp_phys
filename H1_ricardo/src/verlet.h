...
extern void lattice_velocity_verlet_scaled(int n_timesteps, double a0, double Nc,
  ...
  unsigned int enable_scaling, double temp_eq, double pressure_eq, double Temp[n_timesteps], double Pressure[n_timesteps], double a0_ev[n_timesteps], double time_array[n_timesteps+1]);
